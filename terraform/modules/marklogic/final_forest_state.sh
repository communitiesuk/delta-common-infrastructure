...
aws_retry s3 cp --region ${AWS_REGION} s3://${MARKLOGIC_CONFIG_BUCKET}/final_forest_state.xqy /patching/final_forest_state.xqy
aws_retry s3 cp --region ${AWS_REGION} s3://${MARKLOGIC_CONFIG_BUCKET}/manage-forest-status.sh /patching/manage-forest-status.sh
