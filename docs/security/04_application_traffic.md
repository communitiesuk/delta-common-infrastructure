...
In production the Delta API and CPM CloudFront distributions are IP restricted to lists that include developers and consumers of the APIs. See [ip_lists.tf](../../terraform/production/ip_lists.tf) for the allowlists.
